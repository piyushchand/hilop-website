...
const filterOptions: Array<"All" | OrderStatus> = [
  "All",
  "processing",
  "delivered",
  "cancelled",
              ...
              {availableStatuses.map((status) => (
                <SwiperSlide key={status} className="!w-fit">
                  <Button
                    ...
                    variant={
                      activeFilter === status ? "btn-primary" : "btn-light"
                    }
                    size="xl"
                  />
                </SwiperSlide>
                ...
                <>
                  ...
                  <div className="max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="px-6 border-gray-200">
                      <h3 className="font-medium text-dark text-lg mb-3">
                        Order Items
                      </h3>
                        ...
                        {modalOrder.items.map((item, i) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <p className="text-lg text-dark font-medium mb-1 line-clamp-2">
                                {item.name}
                              </p>
                    ...
                    {modalOrder.shipping_address && (
                      <div className="p-6 border-b border-gray-200">
                        ...
                        <p className="text-gray-600 mt-2">
                          {formatAddress(modalOrder.shipping_address)}
                        </p>
                      </div>
                    )}
