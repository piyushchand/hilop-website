    ...
    return (
      ...
      >
        <div className="sm:col-span-5 col-span-12 h-full relative overflow-hidden sm:flex flex-col sm:order-1 order-2 bg-dark sm:bg-white">
          <p className="text-lg md:text-2xl font-semibold ps-6 pt-6 relative z-10 text-white mb-4">
            My plans
          </p>
          ...
          />
          <div className="h-52 hidden sm:block absolute bg-gradient-to-b from-transparent to-dark w-full bottom-0 "></div>
          <div className="h-52 hidden sm:block absolute bg-gradient-to-b from-dark to-transparent w-full top-0 "></div>
        </div>
        ...
        My Plans & Kit Guide
          ...
          <div className="px-6 pb-6 pt-0 overflow-x-auto">
          <div className="flex flex-col gap-4 max-h-[500px] overflow-x-visible mb-6">
              ...
              <div className="mb-4 flex flex-col lg:flex-row lg:items-center gap-3">
                <Image
                  ...
                  <div className="flex justify-between w-full items-start gap-4">
                   <div>
                   <p className="lg:text-xl text-md font-medium mb-3">Anti-Aging Cream for men</p>
            ...
            />
              ...
              <p className="font-medium text-lg mb-2">How to use</p>
              <p className="text-gray-700">Take 1 morning and evening capsules daily with a glass of water, preferably with a meal. For best results, use consistently over time and combine with regular exercise and a balanced diet.</p>
            </div>
            <div className="bg-gray-200 p-2 rounded-lg product card">
              <div className="mb-4 flex flex-col lg:flex-row lg:items-center gap-3">
                <Image
