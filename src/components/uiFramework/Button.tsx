...
const Button = ({
  ...
  const variantClasses: Record<string, string> = {
    "btn-light":
      "bg-white/10 backdrop-blur-lg border border-gray-200 hover:primary",
    ...
    "btn-dark": "bg-dark border border-gray-900 !text-white",
    "btn-primary":
...
`.trim();
  ...
  if (link && newTab) {
    return (
      <Link href={link} target="_blank" className={commonClasses}>
